...
data_dir = ("data/")
dat = pd.read_csv(os.path.join(data_dir,'BRCA_node.csv'))
...
expression_matrix = pd.read_csv(os.path.join(data_dir,'BRCA_node.csv'), index_col=0)
gene_gene_edges = pd.read_csv(os.path.join(data_dir,'BRCA_edges.csv'))
